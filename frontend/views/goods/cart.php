...
<body>
	...
	<div class="mycart w990 mt10 bc">
            ...
            <?php foreach($goods as $good):
             ...
             ?>
				<tr>
					...
					<td class="col6"><a href="JavaScript:;" class="del" id="<?$good->id?>">删除</a></td>
				</tr>
            <?php   endforeach;  ?>
			</tbody>
			<tfoot>
		...
		<div class="cart_btn w990 bc mt10">
			<a href="/adress/index" class="continue">继续购物</a>
			<a href="/order/add" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
