		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
                        ...
                        <div class="midpic">
                            <a href="http://www.myshopadmin.com/uploads/5a0aede772518.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                                <img src="http://www.myshopadmin.com/uploads/5a0aede772518.jpg" alt="" />               <!-- 第一幅图片的中图 -->
                            </a>
                        </div>
...
<!--判断是否是第一个-->
								...
								<li class="<?= ($k==0?"cur":"") ?>">
									<a class="<?=($k==0 ?"zoomThumbActive":'')?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://www.myshopadmin.com<?=$value["path"]?>',largeimage: 'http://www.myshopadmin.com<?=$value["path"]?>'}"><img src="http://www.myshopadmin.com<?=$value["path"]?>"></a>
								</li>
                                <?php endforeach; ?>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="cart" method="post" class="choose">
						<ul>
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								...
								<li><span>商品编号：</span><?=$good["name"]?></li>
						...
						<div class="desc mt10">
							...
							<img src="http://www.myshopadmin.com<?=$v["path"]?>" alt="" />
