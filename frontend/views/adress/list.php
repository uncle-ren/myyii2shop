	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！[<a href="/member/login">登录</a>] [<a href="/member/enroll">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
                ...
                <div class="cat_bd none">
                    <div class="cat item1">
                        <h3><a href="/adress/goods?id=<?=$category["id"]?>"><?=$category["name"]?></a> <b></b></h3>
                        <div class="cat_detail">
                            <?php    foreach(\backend\models\Goods_category::find()->where(["parent_id"=>$category["id"]])->all()  as  $child_cate):?>
                                <dl class="dl_1st">
                                    <dt><a href="/adress/goods?id=<?=$child_cate["id"]?>"><?=   $child_cate["name"]?></a></dt>
                                    <?php    foreach(\backend\models\Goods_category::find()->where(["parent_id"=>$child_cate["id"]])->all()  as  $child_category):?>
                                        <dd>
                                            <a href="/adress/goods?id=<?=$child_category["id"]?>"><?=$child_category["name"]?></a>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="/goods/detail?id=<?=$good["id"]?>"><img src=http://www.myshopadmin.com<?=$good["logo"]  ?> alt="" /></a></dt>
							<dd><a href="/goods/detail?id=<?=$good["id"]?>"><?=$good["name"]?></a></dt>
							<dd><strong>￥<?=$good["shop_price"]?></strong></dt>
							<dd><a href="/goods/detail?id=<?=$good["id"]?>"><em>已有<?=$good["view_times"]?>人评价</em></a></dt>
						</dl>
					</li>
                    <?php  endforeach; ?>
				</ul>
